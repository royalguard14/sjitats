...
class MLX90640:
    ...
    def _ExtractDeviatingPixels(self) -> None:
        ...
        if len(self.brokenPixels) > 4:
            print("More than 4 broken pixels")
        if len(self.outlierPixels) > 4:
            #print("More than 4 outlier pixels")
            print("⚠️ Ignoring outlier pixel warning")

        if (len(self.brokenPixels) + len(self.outlierPixels)) > 4:
            #print("More than 4 faulty pixels")
            print("⚠️ Ignoring pixel error")
